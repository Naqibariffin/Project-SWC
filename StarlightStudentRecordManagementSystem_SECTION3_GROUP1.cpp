...
void displayTopLowRecord(int numStudent, int studentID[], string studentName[], double scores[]) {
    ...
    cout << "**************************************************************************************" << endl;
    cout << "--------------------------------------------------------------------------------------" << endl;
	cout << "|" << left << setw(6) << "Rank" << setw(10) << "ID" << setw(20) << "Score" << setw(48) << "Student Name" << "|" << endl;
    cout << "--------------------------------------------------------------------------------------" << endl;

    for (int i = 0; i < min(numStudent, 5); ++i) {
        int topIndex = topIndices[i];
		cout << "|" << left << setw(6) << i + 1 << setw(10) << studentID[topIndex] << setw(20) << fixed << setprecision(2) << scores[topIndex] <<  setw(43) << studentName[topIndex].substr(0, 40) << endl;
	}
	...
	for (int i = 0; i < min(numStudent, 5); ++i) {
    	...
    	cout << "|" << left << setw(6) << i + 1 << setw(10) << studentID[lowIndex] << setw(20) << fixed << setprecision(2) << scores[lowIndex] <<  setw(43) << studentName[lowIndex].substr(0, 40) << endl;
	}
